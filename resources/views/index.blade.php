...
<script src="{{asset('js/script1.js')}}"></script>
  ...
  pagination: {
    ...
    <!--<script src="https://printmeall.com/js/popup.js"></script>-->
    <!-- Initialize Swiper
...
@section('content')
    ...
    <!--        <div class="verified-overlay"></div>-->
    <!--        <div class="verified-content">-->
    <!--            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aperiam earum dolor magni consequuntur esse-->
    <!--                ipsum. Quisquam blanditiis repudiandae perspiciatis id autem? Modi obcaecati dolorem exercitationem-->
    <!--                dolor earum in consequatur ad?</p>-->
    <!--            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis maxime ducimus, dicta nam-->
    <!--                voluptatem-->
    <!--                numquam.</p>-->
    <!--            <div class="button">-->
    <!--                <button class="verified-btn">Ok</button>-->
    <!--            </div>-->

    <!--        </div>-->
    <!--    </div>-->
    <!--    <div class="hole-overlay hole1">-->
    <!--        <div class="hole">-->

    <!--        </div><img src="{{ asset('images1/account.png')}}" alt="">-->
    <!--        <div class="text">-->
    <!--            <p>Account</p>-->
    <!--        </div>-->
    <!--    </div>-->
    ...
    <div class="box-style">
        ...
        <div class="cards">
                    <div >
        @foreach( $pcategories->chunk(7) as $product )
            ...
            <div class="slider-products-cards">
                        ...
                        <div class="product-card">
                           ...
                           <img src="{{url('/')}}/public/images/{{ $product->image }}" alt="">                @endif
                            ...
                            <div class="card-btn">
                                <a href="{{ url('category/'.preg_replace('/\s+/', '', $product->slug))}}">View more</a>
                            </div>
                        </div>
                                </div>
                                @endforeach
                    ...
                    <div class="row">
                        <div class="level beginner-level col-md-3">
                            <div class="inner-level">
                                ...
                                <div class="level-description">
                                    @foreach($fcategory->where('MainId','4') as $bcategory)
                                    <li><a href="{{url('subcategory')}}/{{$bcategory->slug}}">{{$bcategory->name}}</a></li>
                                    @endforeach
                                </div>
                                <div class="level-btn">
                                    <a href="{{url('/')}}/category/print-products">See all</a>
                                </div>
                            </div>
                        </div>
                        <div class="level intermediate-level col-md-3">
                            <div class="inner-level">
                                ...
                                <div class="level-description">
                                    @foreach($fcategory->where('MainId',12) as $bcategory)
                                    <li><a href="{{url('subcategory')}}/{{$bcategory->slug}}">{{$bcategory->name}}</a></li>
                                    @endforeach
                                    <li><a href="{{url('/')}}/category/labels-and-stickers">Labels and Stickers</a></li>
                                </div>
                                <div class="level-btn">
                                    <a href="{{url('/')}}/category/large-prints">See all</a>
                                </div>
                            </div>
                        </div>
                        <div class="level expert-level col-md-3">
                            <div class="inner-level">
                                ...
                                <div class="level-description">
                                    @foreach($fcategory->where('MainId',5) as $bcategory)
                                    <li><a href="{{url('subcategory')}}/{{$bcategory->slug}}">{{$bcategory->name}}</a></li>
                                    @endforeach
                                </div>
                                <div class="level-btn">
                                    <a href="{{url('/')}}/category/packaging">See all</a>
                                </div>
                            </div>
                        </div>
                        <div class="level guru-level col-md-3">
                            <div class="inner-level">
                                ...
                                <div class="level-description">
                                    @foreach($fcategory->where('MainId',9) as $bcategory)
                                    <li><a href="{{url('subcategory')}}/{{$bcategory->slug}}">{{$bcategory->name}}</a></li>
                                    @endforeach
                                </div>
                                <div class="level-btn">
                                    <a href="{{url('/')}}/category/gift-items">See all</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="container" style="margin-top:4%">
     <div class="row">
                    <div class="col-sm-4">
                        <img src="https://printmeall.com/images/mainiamge.png" style="width:310px; margin-top:4%; margin-left:10%; border-radius:12px;" />
                    </div>
                    <div class="col-sm-8">
                <div style="margin-left:3%">
                <p class="faq-head" style="font-size:38px;">
        ...
        <div class="" style="margin-top:5%;">
            <iframe src="https://printmeall.com/top-picks" width="100%" height="950px" frameBorder="0">Browser not compatible.</iframe>
