          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Add Shop Products</h3>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-email" class="form-control" placeholder="Meta" name="metadesc" wire:model="metadesc" required>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="number" id="input-first-name" class="form-control" placeholder="40 PKR" name="toprice" wire:model="toprice" required>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="number" id="input-last-name" class="form-control" placeholder="50 USD" name="fromprice" wire:model="fromprice" required/>
                     ...
                     <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="number" id="input-last-name" class="form-control" placeholder="50 UAE" name="fromprice" wire:model="UaeCurrency" required/>
                   ...
                   <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="number" id="input-first-name" class="form-control" placeholder="40"  wire:model="pkr_sale" required/>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="number" id="input-last-name" class="form-control" placeholder="50" name="fromprice" wire:model="usd_sale" required/>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="number" id="input-last-name" class="form-control" placeholder="50" name="fromprice" wire:model="uae_sale" required/>
                   ...
                   <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-first-name" class="form-control" value="0" placeholder="40" name="SKU" wire:model="SKU" required/>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="number" id="input-last-name" class="form-control" placeholder="50" name="quantity" wire:model="quantity" required/>
               ...
               <center><button class="btn btn-sm btn-lg btn-primary" >Add Product</button></center> 
                ...
                <div class="pl-lg-4">
                  <div class="form-group" wire:ignore>
                    ...
                    <textarea rows="14" class="form-control " id="editorr" data-editorr="@this" placeholder="A few words about you ..." name="desc" wire:model="desc" required></textarea>
                  </div>
                </div> 
    ...
    <div id="collapseThree{{$outer_key}}" class="colapse" aria-labelledby="headingThree{{$outer_key}}" data-parent="#accordion">
      <div class="card-body">
                 ...
                 <div class="col-md-4">
                  ...
                  <input type="number" value="0" class="form-control" wire:model="variation_array.{{$value_variations}}.sale_price" required/>
                   </div>
                   <div class="col-md-4">
                       <label class="form-control-label" for="input-last-name">USD Sale Price</label>
