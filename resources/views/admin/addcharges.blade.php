          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Add Country and Their Charges </h3>
            ...
            <div class="card-body">
              <form action="{{ url('addcountrycharges') }}" method="POST" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control" name="name" placeholder="Country Name" required>
                      </div>
                    </div>
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Country Code</label>
                        <input type="text" id="input-email" class="form-control" placeholder="Country Code" name="CountryCode" required>
                      </div>
                    </div>
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">Weight Charges (Per KG)</label>
                        <input type="text" id="input-email" class="form-control" placeholder="Weight Charges (Per KG)" name="charges" required>
                     </div>
                    </div>
                  </div>
               <center><button class="btn btn-sm btn-lg btn-primary">Add Charges</button></center> 
              </form>
            </div>
          </div>
        </div>
