          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Add Category For Products</h3>
                ...
                <div class="col-4 text-right">
                  <a href="{{url('allrcats')}}" class="btn btn-sm btn-primary">All Shop Categories</a>
                </div>
              </div>
            </div>
            <div class="card-body">
              <form action="{{ url('addrcatquery') }}" method="POST" enctype="multipart/form-data">
                  {{ csrf_field() }}
