      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
                @foreach($cats as $cat)
              <form action="{{ url('updatecouponquery') }}" method="POST" enctype="multipart/form-data">
                  {{ csrf_field() }}
                <h6 class="heading-small text-muted mb-4">Coupon Info</h6>
                   <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control" value="{{$cat->code}}" name="coupon-code" placeholder="Coupon Code" required>
                      </div>
                    </div>
                    <div class="col-lg-12">
                      <div class="form-group">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" value="{{$cat->value}}" class="form-control" name="coupon-value" placeholder="Coupon Value" required>
                      </div>
                    </div>
                     <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Cart Value</label>
                        <input type="text" id="input-username" value="{{$cat->card_value}}" class="form-control" name="cart-value" placeholder="Cart Value" required>
                      </div>
                    </div>
                     <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Expiry Date</label>
                        <input type="date" id="input-username" value="{{$cat->expire}}" class="form-control" name="expire" placeholder="Expiry Date " required>
                      </div>
                    </div>
                  </div>
               <center><button class="btn btn-sm btn-lg btn-primary">Update Coupon</button></center> 
              </form>
              @endforeach
            </div>
          </div>
