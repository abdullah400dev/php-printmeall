            ...
            <div class="card-header">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                  <a href="{{url('allsubcats')}}" class="btn btn-sm btn-primary">All Sub Categories</a>
                </div>
              </div>
            </div>
            <div class="card-body">
              <form action="{{ url('addsubcatquery') }}" method="POST" enctype="multipart/form-data">
                  {{ csrf_field() }}
               ...
               <center><button class="btn btn-sm btn-lg btn-primary">Add Category</button></center> 
              </form>
            </div>
          </div>
        </div>
