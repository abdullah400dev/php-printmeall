          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Add Shop Sub Category </h3>
                ...
                <div class="col-4 text-right">
                  <a href="{{url('allsubcats')}}" class="btn btn-sm btn-primary">All Shop Sub Categories</a>
                </div>
              </div>
            </div>
            <div class="card-body">
              <form action="{{ url('addrsubcatquery') }}" method="POST" enctype="multipart/form-data">
                  {{ csrf_field() }}
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Sub Category Meta Description</label>
               ...
               <center><button class="btn btn-sm btn-lg btn-primary">Add Shop Sub Category</button></center> 
              </form>
            </div>
          </div>
        </div>
