            ...
            <div class="card-header">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                  <a href="{{url('allattributes')}}" class="btn btn-sm btn-primary">All Attributes</a>
                </div>
              </div>
            </div>
            <div class="card-body">
              <form action="{{ url('addattributequery') }}" method="POST" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control" name="name" placeholder="Attribute Name" required>
                      </div>
                    </div>
                  </div>
               <center><button class="btn btn-sm btn-lg btn-primary">Add Attribute</button></center> 
              </form>
            </div>
          </div>
        </div>
