...
@section('styles')
           <title>Career Opportunity At PrintMeAll</title>
            <meta name="description" content="Career Opportunity At PrintMeAll">
...
<div >
    <div class="quote-top">
        <h2 class="quote-head"><center>Join Us</center></h2>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="quote-orm-col"  style="width:60%; margin:auto">
