    ...
    <div class="accordion" id="accordionExample">
        ...
        <div class="card">
            ...
            <div id="coll{{$category->id}}" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                <div class="card-body">
                    <p>
                    @foreach( $category->subcates as $subcategory ) 
                   <p> <a href="{{url('subcat/'.$subcategory->id)}}" style="color:black;">{{$subcategory->name}}</a></p>
                    @endforeach
                    </p>
                </div>
            </div>
